...
namespace InstaSharper.API
{
    internal class InstaApi : IInstaApi
    {
        ...
        public async Task<IResult<InstaMediaList>> GetUserMediaByPkAsync(long pk,
            PaginationParameters paginationParameters)
        {
            ValidateUser();
            ValidateLoggedIn();
            return await _userProcessor.GetUserMediaAsync(pk, paginationParameters);
        }
        ...
        public async Task<IResult<InstaCurrentUser>> GetUserByIdAsync(string pk)
        {
            ValidateUser();
            ValidateLoggedIn();
            return await _userProcessor.GetUserByIdAsync(pk);
        }
